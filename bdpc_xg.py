...
def get_kwds(html,url):
	...
	if '_百度搜索' in title and 'https://www.baidu.com/s?' in url:
		# 无相关搜索,不会报错
		xg_kwds = doc('#rs_new table tr td a').items()
...
def main():
	while 1:
		kwd = q.get()
		url = f'https://www.baidu.com/s?tn=48020221_28_hao_pg&ie=utf-8&word={kwd}'
		try:
